> **Markdown render for GitHub browsing** — the typeset versions are canonical: [HTML](https://haukehillebrandt.github.io/natex/) · [PDF](https://haukehillebrandt.github.io/natex/paper.pdf) · [PDF in this repo](./main.pdf)
